...
const configArray = [
  {
    ...
    https://pl.wikipedia.org/wiki/Teatr_Współczesny_w_Szczecinie` ,
  },
  {
    background: '#katedra',
    ...
    https://pl.wikipedia.org/wiki/Bazylika_archikatedralna_św._Jakuba_w_Szczecinie `,
  },
  {
    ...
    https://pl.wikipedia.org/wiki/Filharmonia_im._Mieczysława_Karłowicza_w_Szczecinie `,
  },
  {
    background: '#urzad',
    ...
    https://pl.wikipedia.org/wiki/Urząd_Miasta_Szczecin `,
  },
  {
    background: '#bPortowa',
    ...
    https://pl.wikipedia.org/wiki/Brama_Portowa_w_Szczecinie `,
  },
  {
    background: '#dworzec',
    ...
    https://pl.wikipedia.org/wiki/Szczecin_Główny `,
  },
  {
    background: '#fontanna',
    ...
    https://pl.wikipedia.org/wiki/Wały_Chrobrego `,
  },
  {
    background: '#ratusz',
    ...
    https://muzeum.szczecin.pl/o-muzeum/siedziby/muzeum-narodowe-w-szczecinie-muzeum-historii-szczecina.html `,
  },
  {
    ...
    https://pl.wikipedia.org/wiki/Kościół_św._Wojciecha_w_Szczecinie `,
  },
  {
    background: '#komenda',
    ...
    The headquarters is located at 47 Malopolska Street, in the central part of the city, in the Old Town, near to the Mieczyslaw Karlowicz Philharmonic. Chrobry Embankment is located a few dozen meters from the headquarters.
    
    https://eturystyka.wzp.pl/Zaplanuj_pobyt-Przydatne_informacje-Policja/a,8879` ,
  },
  {
    background: '#kotwica',
